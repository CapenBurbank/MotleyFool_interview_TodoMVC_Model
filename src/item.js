/**
 * @typedef {!{id: number, completed: boolean, title: string, priority: number}}
 */
export var Item;
...
/**
 * @typedef {!({id: number}|{completed: boolean}|{priority: number}|EmptyItemQuery)}
 */
export var ItemQuery;

/**
 * @typedef {!({id: number, title: string}|{id: number, completed: boolean}|{id: number, priority: number})}
 */
