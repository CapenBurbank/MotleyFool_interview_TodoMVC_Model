    ...
    */
    ...
    Layout.prototype.isFirstLineFitForCell = function (bottom, cellWidget) {
        ...
        if (cellWidget.childWidgets[0] instanceof ParagraphWidget) {
            ...
            var isLineFitForPara = this.isFirstLineFitForPara(bottom - cellWidget.margin.bottom, paraWidget);
    ...
    //#region shifting
    Layout.prototype.layoutNextItemsBlock = function (blockAdv, viewer, isFootnotRelayout) {
    ...
    Layout.prototype.reLayoutTable = function (block, isFootnotRelayout) {
