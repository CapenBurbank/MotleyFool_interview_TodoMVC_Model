...
import { FootNoteWidgetsInfo } from '../editor/editor-helper';
import { WBorder, WBorders, WListFormat } from '../format/index';
import { WList } from '../list/list';
import { WListLevel } from '../list/list-level';
import { BlockContainer, BlockWidget, BodyWidget, ElementBox, FieldElementBox, HeaderFooterWidget, LineWidget, Page, ParagraphWidget, Rect, TableCellWidget, TableRowWidget, TableWidget, Widget, FootnoteElementBox, FootNoteWidget } from './page';
...
export declare class Layout {
    ...
    */
    ...
    layoutNextItemsBlock(blockAdv: BlockWidget, viewer: LayoutViewer, isFootnotRelayout?: boolean): void;
    /**
     * @private
     */
    ...
    private reLayoutRow;
    reLayoutTable(block: BlockWidget, isFootnotRelayout?: boolean): void;
