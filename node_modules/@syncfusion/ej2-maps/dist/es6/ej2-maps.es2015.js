...
let Maps = class Maps extends Component {
    ...
    mapsOnClick(e) {
        ...
        if (targetEle.id.indexOf('_ToolBar') === -1) {
            let latLongValue = this.getClickLocation(targetId, e.pageX, e.pageY, targetEle, e['layerX'], e['layerY']);
    ...
    mouseEndOnMap(e) {
        ...
        if (this.isTouch) {
            if (targetEle.id.indexOf('_ToolBar') === -1) {
                let latLongValue = this.getClickLocation(targetId, pageX, pageY, targetEle, pageX, pageY);
                if (!isNullOrUndefined(latLongValue)) {
                    latitude = latLongValue.latitude;
                    longitude = latLongValue.longitude;
                }
