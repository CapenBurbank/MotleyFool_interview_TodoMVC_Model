...
var TextSelection = /** @class */ (function () {
    ...
    TextSelection.prototype.calculateContextMenuPosition = function (top, left) {
        ...
        // eslint-disable-next-line
        var highlightButton = document.getElementById(this.pdfViewer.element.id + '_highlight');
        // eslint-disable-next-line
        var underlineButton = document.getElementById(this.pdfViewer.element.id + '_underline');
        // eslint-disable-next-line
        var strikethroughButton = document.getElementById(this.pdfViewer.element.id + '_strikethrough');
